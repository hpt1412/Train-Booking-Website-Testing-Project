...
public class LoginPage extends GeneralPage {
    ...
    private final By tabForgotPW = By.xpath("//a[@href='/Account/ForgotPassword.cshtml']");
    //Elements
    ...
    protected WebElement getTabForgotPW(){
        return Constant.WEBDRIVER.findElement(tabForgotPW);
    }
